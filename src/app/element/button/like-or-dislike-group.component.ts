...
export class LikeOrDislikeButtonGroupComponent implements AfterViewInit {
  ...
  public ngAfterViewInit() {
    ...
    this.likeBtnEl = el.querySelector('[like-button]')
      ? el.querySelector('[like-button]')
      : document.createElement('button');
    this.dislikeBtnEl = el.querySelector('[dislike-button]')
      ? el.querySelector('[dislike-button]')
      : document.createElement('button');
  ...
  public removeDislike() {
    ...
    HttpService.api()
      .delete(
        'dislikes/' + this.related.getRelations().dislike.getAttrs().id,
        {}
      )
      .subscribe(() => {
